...
export default function EditPost({ blogPost }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(`/admin/edit-posts/${blogPost.id}`, {
            forceFormData: true,
        });
    };
    ...
    return (
        <>
            <Head title={`Admin - Edit: ${blogPost.title || 'Post'}`} />
                ...
                <main className="admin-main">
                    <header className="admin-header">
                        <div className="admin-header-content">
                            <h2 className="admin-title">Edit Post</h2>
                        </div>
                    </header>
                        ...
                        <div className="admin-form-card">
                            ...
                            <form onSubmit={handleSubmit} className="admin-form">
                                ...
                                <div className="admin-form-group">
                                    ...
                                    <div className="admin-file-upload">
                                        ...
                                        <label htmlFor="image" className="admin-file-label">
                                            ...
                                            {data.image ? data.image.name : blogPost.image ? 'Replace thumbnail image' : 'Choose thumbnail image'}
                                        </label>
                                        {data.image && (
                                            <button
                                                type="button"
                                ...
                                <div className="admin-form-group">
                                    ...
                                    {blogPost.mp3 && (
                                        <div className="admin-current-file">
                                            <span>Current file: {blogPost.mp3}</span>
                                            <audio controls className="admin-audio-preview">
                                                <source src={`/storage/${blogPost.mp3}`} type="audio/mpeg" />
                                    ...
                                    <div className="admin-file-upload">
                                        ...
                                        <label htmlFor="mp3" className="admin-file-label">
                                            ...
                                            {data.mp3 ? data.mp3.name : blogPost.mp3 ? 'Replace MP3 file' : 'Choose MP3 file'}
                                        </label>
                                        {data.mp3 && (
                                            <button
                                                type="button"
